...
function request1($url, $token = null, $data = null, $pin = null, $otpsetpin = null, $uuid = null){
    //Medan GOFOOD 60% -5.1362".mt_rand(100,999).",119.42".mt_rand(1000,9999);
//bekasi
$header[] = "Host: api.gojekapi.com";
$header[] = "User-Agent: okhttp/3.10.0";
$header[] = "Accept: application/json";
...
$header[] = "Connection: keep-alive";
$header[] = "X-User-Locale: id_ID";
$header[] = "X-Location: -7.8228".mt_rand(100,999).",112.01".mt_rand(1000,9999);
if ($pin):
$header[] = "pin: $pin";
    endif;
if ($token):
...
function request2($url, $token = null, $data = null, $pin = null, $otpsetpin = null, $uuid = null){
    // MAKASAAR GO-FOOD 20K -5.157986171113407,119.4469203427434";
    //BEKASI (-6.166838, 106.728745)
$header[] = "Host: api.gojekapi.com";
$header[] = "User-Agent: okhttp/3.10.0";
$header[] = "Accept: application/json";
$header[] = "Accept-Language: id-ID";
...
$header[] = "Connection: keep-alive";
$header[] = "X-User-Locale: id_ID";
$header[] = "X-Location:-7.472.".mt_rand(100,999).",112.66".mt_rand(1000,9999);
if ($pin):
$header[] = "pin: $pin";
    endif;
if ($token):
...
$header[] = "Connection: keep-alive";
$header[] = "X-User-Locale: id_ID";
$header[] = "X-Location: -6.917".mt_rand(100,999).",107.61".mt_rand(1000,9999);
if ($pin):
$header[] = "pin: $pin";
    endif;
if ($token):
...
function request4($url, $token = null, $data = null, $pin = null, $otpsetpin = null, $uuid = null){
    // BATAM GO-FOOD 15K = 1.130078,104.052917";
$header[] = "Host: api.gojekapi.com";
$header[] = "User-Agent: okhttp/3.10.0";
$header[] = "Accept: application/json";
$header[] = "Accept-Language: id-ID";
...
$header[] = "Connection: keep-alive";
$header[] = "X-User-Locale: id_ID";
$header[] = "X-Location: -7.842".mt_rand(100,999).",110.42".mt_rand(1000,9999);
if ($pin):
$header[] = "pin: $pin";
    endif;
if ($token):
...
$header[] = "Connection: keep-alive";
$header[] = "X-User-Locale: id_ID";
$header[] = "X-Location: -6.214166,106.130284";
if ($pin):
$header[] = "pin: $pin";
    endif;
if ($token):
